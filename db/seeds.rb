...
pikatchu = Pokemon.create(name: "Pikatchu", weigth: 6, height: 0, price: 70, user: user2)
...
pikatchu.image.attach(io: File.open(File.join(Rails.root,'app/assets/images/pikatchu.png')),filename: 'pikatchu.png')
